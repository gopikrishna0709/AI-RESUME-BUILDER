...
export default function HomeHub({ activeResume, onSelectTab, onOpenCreateResume }) {
  const { user } = useAuth();
  const [activeDemoStage, setActiveDemoStage] = useState(3); // Interactive Match Flow Step
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-8">
      ...
      <section className="bg-surface-card border border-surface-border rounded-3xl p-6 sm:p-10 lg:p-12 shadow-card transition-colors duration-200">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Left Column: Strong Editorial Typography & Value Prop */}
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-5xl font-black text-surface-text tracking-tight leading-[1.12] font-display">
              Build a Resume That <br className="hidden sm:inline" />
              <span className="text-plum-900 dark:text-plum-300 underline decoration-terracotta-400 underline-offset-8">
                Gets Matched.
              </span>
            </h1>

            <p className="text-surface-muted text-sm sm:text-base leading-relaxed max-w-xl">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <button
                ...
                className="flex items-center gap-2.5 px-6 py-3.5 rounded-xl bg-plum-900 hover:bg-plum-800 text-white font-bold text-xs sm:text-sm shadow-card active:scale-[0.98] transition-all"
              >
                <FileText className="w-4 h-4 text-terracotta-300" />
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-3.5 rounded-xl bg-surface-elevated hover:bg-surface-hover text-surface-text border border-surface-border font-bold text-xs sm:text-sm transition-all"
              >
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2 text-xs text-surface-muted font-medium">
              ...
              <div className="flex items-center gap-1.5">
                <Check className="w-3.5 h-3.5 text-sage-600 dark:text-sage-400" />
                <span>Multi-Template PDF Export</span>
              </div>
            </div>
          </div>

          {/* Right Column: Unique Interactive Match Pipeline Visualization */}
          <div className="lg:col-span-5 bg-surface-elevated border border-surface-border rounded-2xl p-5 sm:p-6 space-y-4 shadow-subtle">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-plum-100 dark:bg-plum-950 text-plum-900 dark:text-plum-200 flex items-center justify-center text-xs font-bold">
                      1
                    </div>
                    <div>
                      <div className="font-bold text-xs text-surface-text">Resume Profile</div>
                      <div className="text-[10px] text-surface-muted">Alex Rivera • {experienceCount} Positions • {skillCount} Skills</div>
                    </div>
                  </div>
              ...
              <div className="text-center text-terracotta-500 font-bold text-xs">↓</div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-terracotta-100 dark:bg-terracotta-950 text-terracotta-700 dark:text-terracotta-300 flex items-center justify-center text-xs font-bold">
                      2
                    </div>
                    <div>
                      <div className="font-bold text-xs text-surface-text">Job Requirements</div>
                      <div className="text-[10px] text-surface-muted">Lead Full Stack Engineer • Apex Cloud</div>
                    </div>
                  </div>
                  <CheckCircle2 className="w-4 h-4 text-sage-600 dark:text-sage-400" />
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="font-display font-black text-2xl text-plum-900 dark:text-plum-200">
                      92% Match
                    </div>
                  </div>

                  {/* Circular Radial Gauge Simulation */}
                  <div className="w-14 h-14 rounded-full bg-plum-50 dark:bg-plum-950/80 border-4 border-terracotta-500 flex items-center justify-center font-bold text-xs text-plum-900 dark:text-plum-200">
                    92%
                  </div>
                </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-3 pb-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-surface-elevated hover:bg-surface-hover border border-surface-border text-surface-text text-xs font-bold transition-all"
            >
            ...
            <button
              onClick={() => onSelectTab('builder')}
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-plum-900 hover:bg-plum-800 text-white text-xs font-bold transition-all"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-surface-card border border-surface-border rounded-2xl p-5 shadow-subtle space-y-3">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-surface-text font-display">{atsScore}%</span>
          ...
          <div className="bg-surface-card border border-surface-border rounded-2xl p-5 shadow-subtle space-y-3">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-surface-text font-display">89%</span>
            ...
            <p className="text-[11px] text-surface-muted">Targeting {targetRole.slice(0, 24)}...</p>
          </div>
          ...
          <div className="bg-surface-card border border-surface-border rounded-2xl p-5 shadow-subtle space-y-3">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-black text-surface-text font-display">{skillCount}</span>
          ...
          <div className="bg-surface-card border border-surface-border rounded-2xl p-5 shadow-subtle space-y-3">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-surface-text font-display truncate">
            ...
            <p className="text-[11px] text-surface-muted">{activeResume?.title || 'Active Resume'}</p>
          </div>
        </div>
      </section>

      {/* 3. SOLID FEATURE MODULE MATRIX */}
      <section className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {MODULES.map((mod) => {
            ...
            return (
              <div
                ...
                className={`group bg-surface-card border border-surface-border ${mod.accentBorder} rounded-3xl p-6 shadow-subtle hover:shadow-card transition-all duration-200 hover:-translate-y-1 cursor-pointer flex flex-col justify-between gap-5`}
              >
                <div className="space-y-4">
                  <div className="flex items-center justify-between gap-2">
                    <div className="w-11 h-11 rounded-xl bg-plum-900 text-terracotta-300 flex items-center justify-center font-bold shadow-subtle group-hover:bg-plum-800 transition-colors">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-surface-text group-hover:text-plum-900 dark:group-hover:text-plum-300 transition-colors">
                      {mod.title}
                    </h4>
                ...
                {/* Card CTA */}
                <div className="pt-3 border-t border-surface-border flex items-center justify-between text-xs font-bold text-plum-900 dark:text-plum-300 group-hover:text-terracotta-600 transition-colors">
                  <span>{mod.cta}</span>
          ...
          <div
            onClick={onOpenCreateResume}
            className="group bg-surface-elevated border-2 border-dashed border-surface-border hover:border-terracotta-400 rounded-3xl p-6 shadow-subtle hover:shadow-card transition-all duration-200 hover:-translate-y-1 cursor-pointer flex flex-col items-center justify-center text-center gap-3 min-h-[290px]"
          >
            <div className="w-12 h-12 rounded-xl bg-plum-50 dark:bg-plum-950 text-plum-900 dark:text-plum-200 border border-plum-200 dark:border-plum-800 flex items-center justify-center group-hover:scale-110 transition-transform">
